...
#define CONFIGURE_ARGS "--enable-thread-safety --enable-nls --with-ldap --with-openssl --with-uuid --with-libxml --with-libxslt --with-icu --with-perl --with-python"
...
#define PG_VERSION_NUM 130011

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 13.11, compiled by Visual C++ build " CppAsString2(_MSC_VER) ", 64-bit"
